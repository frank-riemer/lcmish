...
- `lcmish-in-vivo-example.png` shows the full-range LCMish data, ATP-grouped fitted model and residual for a deidentified, phase-corrected eight-voxel mean in-vivo 31P spectrum.
