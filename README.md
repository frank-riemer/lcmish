...
The following example shows an LCMish fit to a deidentified, phase-corrected in-vivo ³¹P spectrum formed by averaging eight retained voxels. The trace is included to illustrate the fitted model and residual produced by the current workflow; it is not presented as cross-fitter validation.

![LCMish fit and residual for a deidentified phase-corrected eight-voxel mean in-vivo 31P spectrum](docs/images/lcmish-in-vivo-example.png)

*Deidentified eight-voxel in-vivo mean, display-normalised to the maximum observed signal.*
