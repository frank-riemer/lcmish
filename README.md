...
The following example shows an LCMish fit to a deidentified in-vivo regional ³¹P spectrum. The trace is included to illustrate the fitted model and residual produced by the current workflow; it is not presented as cross-fitter validation.

![LCMish fit and residual for a deidentified in-vivo 31P regional spectrum](docs/images/lcmish-in-vivo-example.png)

*Deidentified in-vivo example with independently display-normalised signal.*
